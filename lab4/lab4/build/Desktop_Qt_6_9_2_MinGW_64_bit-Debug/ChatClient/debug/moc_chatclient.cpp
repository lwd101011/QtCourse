...
template <> constexpr inline auto ChatClient::qt_create_metaobjectdata<qt_meta_tag_ZN10ChatClientE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'connectToSever'
        QtMocHelpers::SlotData<void(const QHostAddress &, quint16)>(8, 2, QMC::AccessPublic, QMetaType::Void, {{
...
void ChatClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: _t->connectToSever((*reinterpret_cast< std::add_pointer_t<QHostAddress>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<quint16>>(_a[2]))); break;
        default: ;
        }
    }
